...
plt.suptitle("Factors Affecting Population", fontfamily='Algerian',
             fontsize=35, color='white', weight='bold')

# Subplot 1: Bar Plot - Population
ax1 = plt.subplot(2, 2, 1)
sns.barplot(data=df_filtered, x='Year', y='Population, total',
            hue='Country Name', palette=custom_palette)
...
sns.lineplot(data=df_filtered, x='Year', y='Mortality rate, neonatal (per 1,000 live births)',
             hue='Country Name', marker='o', palette=custom_palette, legend=False)
plt.title('Neonatal Mortality Rate', fontsize=14,
          color='white', fontfamily='Times New Roman')
plt.xlabel('Years', fontsize=12, color='white', fontfamily='Times New Roman')
plt.ylabel('Mortality rate, neonatal',  fontsize=12,
           color='white', fontfamily='Times New Roman')
plt.tick_params(axis='x', colors='white', labelsize=8)
plt.tick_params(axis='y', colors='white', labelsize=8)
plt.grid(True, linestyle='--', alpha=0.6)
...
sns.lineplot(data=df_filtered, x='Year', y='Life expectancy at birth, total (years)',
             hue='Country Name', marker='o', palette=custom_palette, legend=False)
plt.title('Life Expectancy Rate', fontsize=14,
          color='white', fontfamily='Times New Roman')
plt.xlabel('Years', fontsize=12, color='white', fontfamily='Times New Roman')
...
India_data = df_filtered[(df_filtered['Country Name'] == 'India') & (
    df_filtered['Year'].isin(india_years))]
sns.barplot(x='Death rate, crude (per 1,000 people)', y='Year',
            data=India_data, palette=custom_palette, orient='h')
plt.xlabel('Death rate, crude (per 1,000 people)', fontsize=12,
           color='white', fontfamily='Times New Roman')
plt.ylabel('Year',  fontsize=12, color='white', fontfamily='Times New Roman')
plt.grid(True, linestyle='--', alpha=0.6)
plt.title('Death rate of India', fontsize=14,
          color='white', fontfamily='Times New Roman')
plt.tick_params(axis='x', colors='white', labelsize=8)
plt.tick_params(axis='y', colors='white', labelsize=8)
